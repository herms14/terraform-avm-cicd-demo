...
| <a name="input_region_cidrs"></a> [region\_cidrs](#input\_region\_cidrs) | n/a | `map(string)` | <pre>{<br>  "eastus": "10.0.0.0/16",<br>  "southeastasia": "10.2.0.0/16",<br>  "westeurope": "10.1.0.0/16"<br>}</pre> | no |
